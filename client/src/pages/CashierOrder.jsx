...
import { ShoppingCart, Plus, Minus, X, Coffee, UtensilsCrossed, GlassWater, ArrowLeft, CreditCard, Wallet } from 'lucide-react'
...
const CashierOrder = () => {
  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="bg-gradient-to-r from-primary-500 to-primary-600 text-white shadow-xl">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              <h1 className="text-4xl font-bold">Kasir - Cozy Corner</h1>
              <p className="text-primary-100">Sistem Pemesanan Kasir</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Success Message */}
      {orderPlaced && (
        <div className="fixed top-4 right-4 bg-green-500 text-white px-6 py-4 rounded-xl shadow-xl z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-6">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {filteredItems.map(item => (
            <div
              key={item.id}
              className={`card p-3 ${item.is_sold_out ? 'opacity-60' : 'hover:scale-105 cursor-pointer'} transition-all duration-300`}
              onClick={() => !item.is_sold_out && handleAddToCartClick(item)}
            >
              ...
              <div className="flex items-center justify-between">
                ...
                {!item.is_sold_out && (
                  <button
                    ...
                    className="bg-primary-500 text-white p-1.5 rounded-lg hover:bg-primary-600 transition-colors"
                  >
              ...
              {cart.length === 0 ? (
                ...
                <>
                  ...
                  <div className="border-t-2 border-gray-200 pt-4 mb-4">
                    ...
                    >
                      {paymentMethod === 'cash' ? 'Proses Pesanan - Tunai' : 'Proses Pesanan - QRIS'}
                    </button>
                  </div>
                </>
              )}
